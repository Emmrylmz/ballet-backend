...
export class InvitationEmailService {
  ...
  /**
   * Generate email template for instructor invitation
   */
  generateInstructorInvitationEmail(
...
${establishmentName} - Powered by Ballet Management System
  ...
  /**
   * Generate email template for student invitation
   */
...
${establishmentName} - Powered by Ballet Management System
  ...
  /**
   * Generate email for invitation acceptance notification (to inviter)
   */
