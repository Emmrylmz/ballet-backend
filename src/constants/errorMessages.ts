...
export const AUTH_ERRORS = {
  ...
  INVALID_PASSWORD_FORMAT: "Şifre en az 8 karakter olmalı ve büyük harf, küçük harf, rakam içermelidir",
...
export const INVITATION_ERRORS = {
  ...
  DUPLICATE_INVITATION: "Bu e-posta adresi için zaten aktif bir davetiye bulunuyor",
  USER_ALREADY_EXISTS: "Bu e-posta adresine sahip kullanıcı zaten bu kurumun üyesi",
  ...
  INVALID_PHONE_FORMAT: "Geçersiz telefon numarası formatı. Lütfen uluslararası format kullanın (örn: +905551234567)",
