...
('b2c3d4e5-f6a7-4801-a345-678901bcdefg', 'Emma Wilson', 'emma@ballet.com', '+1234567891', ARRAY['ballet'], true),
('c3d4e5f6-a7b8-4012-a456-789012cdefgh', 'Lisa Chen', 'lisa@ballet.com', '+1234567892', ARRAY['pilates'], true),
('d4e5f6a7-b8c9-4123-a567-890123defghi', 'Maria Rodriguez', 'maria@ballet.com', '+1234567893', ARRAY['ballet'], false);
...
('cccccccc-cccc-4ccc-accc-cccccccccccc', 'Advanced Ballet', 'ballet', 'advanced', 'b2c3d4e5-f6a7-4801-a345-678901bcdefg', 8, 90, 45.00, 'For experienced ballet dancers', true),
('dddddddd-dddd-4ddd-addd-dddddddddddd', 'Kids Ballet (Ages 5-8)', 'ballet', 'kids', 'b2c3d4e5-f6a7-4801-a345-678901bcdefg', 15, 45, 20.00, 'Fun introduction to ballet for young children', true),
('eeeeeeee-eeee-4eee-aeee-eeeeeeeeeeee', 'Pilates Fundamentals', 'pilates', 'beginner', 'c3d4e5f6-a7b8-4012-a456-789012cdefgh', 12, 60, 30.00, 'Learn the basics of Pilates', true),
('ffffffff-ffff-4fff-afff-ffffffffffff', 'Advanced Pilates', 'pilates', 'advanced', 'c3d4e5f6-a7b8-4012-a456-789012cdefgh', 8, 75, 40.00, 'Challenge yourself with advanced Pilates', true);
...
-- Note: Using session_date instead of start_date, and calculating end_time
...
('90909090-9090-4090-a090-909090909090', 'dddddddd-dddd-4ddd-addd-dddddddddddd', 'b2c3d4e5-f6a7-4801-a345-678901bcdefg', CURRENT_DATE, '15:00:00', '15:45:00', 15, 'scheduled'),

-- This week's classes
('01010101-0101-4101-a101-010101010101', 'eeeeeeee-eeee-4eee-aeee-eeeeeeeeeeee', 'c3d4e5f6-a7b8-4012-a456-789012cdefgh', CURRENT_DATE + INTERVAL '1 day', '18:00:00', '19:00:00', 12, 'scheduled'),
('02020202-0202-4202-a202-020202020202', 'cccccccc-cccc-4ccc-accc-cccccccccccc', 'b2c3d4e5-f6a7-4801-a345-678901bcdefg', CURRENT_DATE + INTERVAL '2 days', '19:00:00', '20:30:00', 8, 'scheduled'),
('03030303-0303-4303-a303-030303030303', 'ffffffff-ffff-4fff-afff-ffffffffffff', 'c3d4e5f6-a7b8-4012-a456-789012cdefgh', CURRENT_DATE + INTERVAL '3 days', '17:30:00', '18:45:00', 8, 'scheduled'),
...
('06060606-0606-4606-a606-060606060606', 'eeeeeeee-eeee-4eee-aeee-eeeeeeeeeeee', 'c3d4e5f6-a7b8-4012-a456-789012cdefgh', CURRENT_DATE - INTERVAL '3 days', '18:00:00', '19:00:00', 12, 'completed');
...
-- Recent payments
('17171717-1717-4717-a717-171717171717', '11111111-1111-4111-a111-111111111111', '99999999-9999-4999-a999-999999999999', 120.00, 'credit_card', 'package', '2024-09-01', 'Monthly package payment'),
...
('19191919-1919-4919-a919-191919191919', '44444444-4444-4444-a444-444444444444', '30303030-3030-4030-a030-303030303030', 180.00, 'credit_card', 'package', '2024-08-15', '8-class package payment'),
