export class InstructorDashboardRepository {
    ...
    async verifyInstructorAccess(userId, establishmentId) {
    ...
    `, [userId, establishmentId]);
        if (result.rows.length === 0) {
            throw new Error("User does not have instructor access to this establishment");
        }
    }
    ...
    async getRecentActivitiesForEstablishment(establishmentId, userId, filters = {}) {
        await this.verifyInstructorAccess(userId, establishmentId);
