export class AuthRepository {
    ...
    async findUserInvitation(token) {
        try {
            const result = await this.db.query(`
    ...
    async getEstablishmentInfo(establishmentId) {
        try {
            const result = await this.db.query(`
    ...
    async storeRegistrationWithToken(email, token, registrationData, expiresAt) {
        try {
            await this.db.query(`
    ...
    async markEmailTokenAsUsed(token) {
        try {
            await this.db.query(`
